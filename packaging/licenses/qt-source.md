...
Linux 另使用 DBus），打包工具还会为 SVG 图标插件带入 Qt SVG。两者均选择
`GPL-3.0-only` 开源许可路径。
...
- `qtsvg-everywhere-src-6.11.2.tar.xz`：<https://download.qt.io/official_releases/qt/6.11/6.11.2/submodules/qtsvg-everywhere-src-6.11.2.tar.xz>，SHA-256 `d594337feca84c26fb67fe87b85e6a5c12fda404b611d905f9d138210c311876`
...
`licenses/qt-modules-6.11.2.spdx` 记录本发行物使用的 Qt Base／Qt SVG、
选择的 GPLv3 路径以及两份对应源码的固定哈希。Actions 另附实际发行目录
